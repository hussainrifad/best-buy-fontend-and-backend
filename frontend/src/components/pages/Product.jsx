...
import { addProducts } from '../reduxCart/cartSlice';
    ...
    return (
        <section className='p-5 text-sm shadow-2xl flex flex-col justify-between'>
            ...
            <div>
                ...
                <button onClick={()=> dispatch(addProducts(prod))} className='w-full font-semibold text-white bg-purple-900 hover:bg-green-700 py-2 flex justify-around items-center'>
